...
DVM_PERMISSIONS = {
    'MANIFEST_PERMISSION': {
        ...
        'ACCESS_LOCATION_EXTRA_COMMANDS': ['normal', '访问额外的位置提供程序命令', '访问额外的位置提供程序命令。恶意应用程序可以利用它来干扰GPS或其他定位源的操作。'],
        ...
        'CAMERA': ['dangerous', '拍摄照片和视频', '允许应用程序拍照和视频与相机。这允许应用程序收集相机在任何时候看到的图像。'],
        ...
        'MODIFY_PHONE_STATE': ['signatureOrSystem', '修改电话状态', '允许应用程序控制的手机通话功能。具有此权限的应用程序可以在不通知你的情况下切换网络、打开或关闭手机收音机等等。'],
        ...
        'RESTART_PACKAGES': ['normal', '杀死后台进程', '允许一个应用程序杀死其他应用程序的后台进程，即使内存不低。'],
        'KILL_BACKGROUND_PROCESSES': ['normal', '杀死后台进程', '允许一个应用程序杀死其他应用程序的后台进程，即使内存不低。'],
        ...
        'SYSTEM_ALERT_WINDOW': ['dangerous', '显示系统级弹框', '允许程序显示系统警报窗口。恶意应用程序可以控制整个手机屏幕。'],
        ...
        'SET_WALLPAPER_HINTS': ['normal', '设置壁纸默认大小', '允许应用程序设置系统壁纸默认大小。'],
        ...
        'BIND_ACCESSIBILITY_SERVICE': ['signature', '', '必须是AccessibilityService所要求的，以确保只有系统可以绑定到它。'],
        ...
        'REQUEST_DELETE_PACKAGES': ['normal', '', '允许程序请求删除包。'],
        ...
        'ACCESS_BACKGROUND_LOCATION': ['dangerous', '后台获取定位', '允许应用程序在后台访问位置。如果您正在请求此权限，您必须同时请求这两种权限'],
        'ACCESS_MEDIA_LOCATION': ['dangerous', '访问任何地理位置', '允许应用程序访问保存在用户共享集合中的任何地理位置。'],
